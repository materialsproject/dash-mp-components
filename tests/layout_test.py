...
from dash_mp_components.test_api import resize_browser_window, DEFAULT_CONTAINER_SELECTOR
...
def test_table_forced_layout(dash_duo, layout):
    periodic_table = PeriodicTable(dash_duo, 'periodic-table', ['Fe', 'Co'], [], ['Na'], layout, DEFAULT_CONTAINER_SELECTOR)
