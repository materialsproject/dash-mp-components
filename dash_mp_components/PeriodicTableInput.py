...
- forceTableLayout (a value equal to: 'spaced', 'compact', 'small', 'map'; optional): Force the table to be in a specific layout"""
    @_explicitize_args
    def __init__(self, id=Component.UNDEFINED, state=Component.UNDEFINED, disabledElements=Component.UNDEFINED, enabledElements=Component.UNDEFINED, hiddenElements=Component.UNDEFINED, maxElementSelectable=Component.UNDEFINED, forceTableLayout=Component.UNDEFINED, **kwargs):
        self._prop_names = ['id', 'state', 'disabledElements', 'enabledElements', 'hiddenElements', 'maxElementSelectable', 'forceTableLayout']
        self._type = 'PeriodicTableInput'
        self._namespace = 'dash_mp_components'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'state', 'disabledElements', 'enabledElements', 'hiddenElements', 'maxElementSelectable', 'forceTableLayout']
