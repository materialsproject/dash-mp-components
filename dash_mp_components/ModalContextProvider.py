...
- active (boolean; optional): The current or default state of the modal. If true, the "is-active" class is added to <Modal/>.
This value can be watched and changed from outside the component (e.g. via dash callback).
- forceAction (boolean; optional): Prevent modal from being closed without completion of a specific action.
