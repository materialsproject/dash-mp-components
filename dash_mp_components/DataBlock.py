...
Keyword arguments:
- children (a list of or a singular dash component, string or number; optional): Content to display in the bottom section of the card.
...
@default false
- footer (a list of or a singular dash component, string or number; optional): Content to display in the bottom section of the card.
