...
- options (list; optional): List of objects to be used as options in the dropdown
e.g.
        [
          {
            'label': 'One',
...
(default: False)
- isMulti (boolean; optional): Set to true if select should allow multiple
...
e.g.
    ...
    def __init__(self, id=Component.UNDEFINED, options=Component.UNDEFINED, value=Component.UNDEFINED, defaultValue=Component.UNDEFINED, isClearable=Component.UNDEFINED, isMulti=Component.UNDEFINED, arbitraryProps=Component.UNDEFINED, **kwargs):
        self._prop_names = ['id', 'options', 'value', 'defaultValue', 'isClearable', 'isMulti', 'arbitraryProps']
        self._type = 'Select'
        self._namespace = 'dash_mp_components'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'options', 'value', 'defaultValue', 'isClearable', 'isMulti', 'arbitraryProps']
