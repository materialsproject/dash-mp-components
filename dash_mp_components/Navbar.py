...
- items (list; optional): An array of navbar-items to show on the right side of the navbar.
...
- brandItem (dict; optional): Single navbar-item to display on the left of the navbar in the "navbar-brand" element.
...
e.g.
    ...
    def __init__(self, id=Component.UNDEFINED, className=Component.UNDEFINED, items=Component.UNDEFINED, brandItem=Component.UNDEFINED, **kwargs):
        self._prop_names = ['id', 'className', 'items', 'brandItem']
        self._type = 'Navbar'
        self._namespace = 'dash_mp_components'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'className', 'items', 'brandItem']
