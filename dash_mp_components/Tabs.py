...
Keyword arguments:
- children (a list of or a singular dash component, string or number; optional): Use the children prop to set the separate tab contents.
...
- className (string; optional): Class name applied to top level wrapper for tabs and tab content.
The "mpc-tabs" class is added automatically
- labels (list of strings; optional): List of strings to use as labels for the tabs.
The number of labels must equal the number of children (i.e. tab content items).
- tabIndex (number; optional): The current or default tabIndex to be active.
This value can be watched and changed from outside the component (e.g. via dash callback).
- arbitraryProps (dict; optional): Object for placing all other props that
...
e.g.
    ...
    def __init__(self, children=None, id=Component.UNDEFINED, className=Component.UNDEFINED, labels=Component.UNDEFINED, tabIndex=Component.UNDEFINED, arbitraryProps=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'className', 'labels', 'tabIndex', 'arbitraryProps']
        self._type = 'Tabs'
        self._namespace = 'dash_mp_components'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'className', 'labels', 'tabIndex', 'arbitraryProps']
