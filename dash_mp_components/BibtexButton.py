...
- className (string; optional): Class name(s) to append to the component's default class (mpc-bibtex-button)
@default 'button is-small'
- doi (string; optional): The DOI (Digital Object Identifier) of the reference
to pass to doi2bib.org.
- url (string; optional): Directly supply the URL to a reference's bibtex.
...
@default '_blank'"""
    ...
    def __init__(self, id=Component.UNDEFINED, className=Component.UNDEFINED, doi=Component.UNDEFINED, url=Component.UNDEFINED, target=Component.UNDEFINED, **kwargs):
        self._prop_names = ['id', 'className', 'doi', 'url', 'target']
        self._type = 'BibtexButton'
        self._namespace = 'dash_mp_components'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'className', 'doi', 'url', 'target']
