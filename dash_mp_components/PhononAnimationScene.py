...
class PhononAnimationScene(Component):
...
- toggleVisibility (optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(PhononAnimationScene, self).__init__(children=children, **args)

setattr(PhononAnimationScene, "__init__", _explicitize_args(PhononAnimationScene.__init__))
