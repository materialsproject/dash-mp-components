        ...
        (function(e) {
            ...
            function T() {
                ...
                return (n = i) && 'function' == typeof n.schedule
                    ? (e.pop(), A(e, i))
                    : (function(e, t) {
                          return t ? A(e, t) : new S(w(e));
                      })(e);
            }
            var C = new S(function(e) {
                return e.complete();
            });
            function j(e) {
                return e
            ...
            var z = (function() {
                ...
                D = (function(e) {
                    ...
                    return (
                        ...
                        (t.prototype._next = function(e) {
                            this.scheduleMessage(z.createNext(e));
                        }),
                        (t.prototype._error = function(e) {
                            this.scheduleMessage(z.createError(e)),
                                this.unsubscribe();
                        }),
                        (t.prototype._complete = function() {
            ...
            const Z = new r.a(),
                K = e.env.DEBUG
                    ? Z.pipe(
                          ((X = e => console.log('ELEMENTS STATE', e)),
                          function(e) {
                              return e.lift(new Y(X, ee, te));
                          }),
                          J(1)
                      )
                    : Z.pipe(J(1));
            ...
            const ne = {
                ...
                addEnabledElement: e =>
                    ($.enabledElements = Object.assign(
                        Object.assign({}, $.enabledElements),
                        {[e]: !0}
                    )) && Z.next($),
                addDisabledElement: e =>
                    ($.disabledElements = Object.assign(
                        Object.assign({}, $.disabledElements),
                        {[e]: !0}
                    )) && Z.next($),
            ...
            Object.seal(ie);
            const re = ie.reduce((e, t) => ((e[t.symbol] = t.class), e), {});
            var oe;
            function ae({
                element: e,
                displayMode: t = oe.SIMPLE,
                hidden: n = !1,
                enabled: r = !1,
                disabled: o = !1,
                onElementClicked: a,
                ...
                return Object(i.createElement)(
                    'div',
                    {
                        onClick: () => (e => a(e))(e),
                        onMouseOver: () => (e => s(e))(e),
                        className: `mat-element ${t} ${re[e.symbol]} ${
                            m ? 'hidden' : ''
                        } ${l ? 'enabled' : ''} ${c ? 'disabled' : ''}`,
                    },
                    t === oe.SIMPLE
            ...
            const se = [
                ...
                le = se.reduce((e, t) => ((e[t.symbol] = t), e), {});
            var ce;
            function me({onTableSwitcherClicked: e}) {
                const t = (function() {
                    ...
                    return (
                        Object(i.useEffect)(() => {
                            const e = K.subscribe(({detailedElement: e}) => {
                                e && t(e);
                            });
            ...
            function ue({
                ...
                const [s, l] = Object(i.useState)(!0),
                    c = Object(o.useMediaQuery)({minWidth: 992}),
                    m = Object(o.useMediaQuery)({minWidth: 768, maxWidth: 991}),
                    u = Object(o.useMediaQuery)({maxWidth: 767});
                return (
                    console.log('hidden', n),
                    Object(i.createElement)(
                        'div',
                        {
                            className: `table-container ${de(c, m, u)} ${
                                s ? '' : 'elements-hidden'
                            }`,
                        },
                        Object(i.createElement)(me, {
                            onTableSwitcherClicked: () => l(!s),
                        }),
                        se.map(o =>
                            Object(i.createElement)(ae, {
            ...
            function de(e, t, n) {
                return e ? ce.SPACED : t ? ce.COMPACT : n ? ce.MINI : ce.SPACED;
            }
            function pe({
                enabledElements: e,
                disabledElements: t,
                ...
                const {
                    ...
                    const [o, a] = Object(i.useState)({}),
                        [s, l] = Object(i.useState)({}),
                        [c, m] = Object(i.useState)({});
                    return (
                        Object(i.useEffect)(() => {
                            const i = K.subscribe(
                                ({
                ...
                return Object(i.createElement)(ue, {
                    onElementClicked: e => ne.toggleEnabledElement(e.symbol),
                    onElementHovered: e => ne.setDetailedElement(e.symbol),
                    disabledElement: a,
                    hiddenElement: s,
                    enabledElement: o,
                });
                ...
                return Object(i.createElement)(
                    ...
                    Object(i.createElement)(
                        ...
                        Object(i.createElement)(
                            ...
                            ye.categories.map((n, r) =>
                                Object(i.createElement)(
                                    'div',
                                    {key: r, className: 'filter-group'},
                                    n.map(n =>
                                        Object(i.createElement)(
                                            'div',
                                            {
                                                ...
                                                onClick: () => {
                                                    t({
                                                        ...
                                                        'All' === n.name &&
                                                            ne.setHiddenElements(
                                                                {}
                                                            );
                                                },
                                                className: `current-filter-selector ${
                                                    n.name === e.topFilter.name
                                                        ? 'selected'
                                                        : ''
                                                }`,
                                            },
                                        ...
                                        onClick: () =>
                                            (function(n) {
                                                ...
                                                console.log(
                                                    ...
                                                    ne.setHiddenElements(r);
                                            })(n),
                                        className: `current-filter-selector ${
                                            n.name === e.lowerFilter.name ||
        ...
        (r.nextTick = function(e) {
            ...
            if (arguments.length > 1)
                for (var n = 1; n < arguments.length; n++)
                    t[n - 1] = arguments[n];
            c.push(new h(e, t)), 1 !== c.length || m || s(p);
        }),
    ...
    function(e, t, n) {
        ...
        (h.defaultProps = {
            ...
            (h.propTypes = {
                id: a.a.string,
                state: a.a.object,
                disabledElements: a.a.object,
                enabledElements: a.a.object,
                hiddenElements: a.a.object,
                setProps: a.a.func,
            });
        var w = (function(e) {
            function t() {
                return (
                    ...
                    f(this, g(t).apply(this, arguments))
                );
            }
            var n, i, o;
            return (
                ...
                (i = [
                    {
                        key: 'render',
                        value: function() {
                            return r.a.createElement(s.b, null);
                        },
                    },
                ]) && b(n.prototype, i),
                o && b(n, o),
