window.dash_mp_components = (function(e) {
    ...
    function(e, t, n) {
        ...
        (function(e) {
                    ...
                    (e.prototype.subscribe = function(e, t, n) {
                        var i = this.operator,
                            r = (function(e, t, n) {
                                ...
                                return e || t || n ? new g(e, t, n) : new g(p);
                            })(e, t, n);
                        if (
                            (i
            ...
            var j = (function() {
                    ...
                    return (
                        (e.prototype.call = function(e, t) {
                            return t.subscribe(
                                new C(e, this.project, this.thisArg)
                            );
                        }),
                        e
                    );
            ...
            var R = (function() {
                ...
                W = (function(e) {
                    ...
                    return (
                        ...
                        (t.prototype._error = function(e) {
                            this.scheduleMessage(M.createError(e)),
                                this.unsubscribe();
                        }),
                        (t.prototype._complete = function() {
            ...
            Object.seal(X);
            const te = Object(i.createContext)({observable: {}, actions: {}});
            function ne(e, t, n, r = 10, o) {
                const [a, s] = Object(i.useState)({}),
                    [l, c] = Object(i.useState)({}),
                    [m, u] = Object(i.useState)({}),
                    {observable: p, actions: d} = Object(i.useContext)(te);
                return (
                    Object(i.useEffect)(() => {
                        d.setMaxSelectionLimit(r);
                        const i = p.subscribe(
                                ({
                                    enabledElements: e,
                                    disabledElements: t,
                                    ...
                                    console.log('change'), s(t), c(e), u(n);
                                }
                            ),
                            a = p
                                .pipe(
            ...
            const ie = [
                ...
                re = ie.reduce((e, t) => ((e[t.symbol] = t), e), {});
            Object.seal(re);
            const oe = [
            ...
            Object.seal(oe);
            const ae = oe.reduce((e, t) => ((e[t.symbol] = t.class), e), {});
            var se, le;
            function ce({
                element: e,
                displayMode: t = se.SIMPLE,
                hidden: n = !1,
                enabled: r = !1,
                disabled: o = !1,
                onElementClicked: a,
                ...
                return Object(i.createElement)(
                    'div',
                    {
                        onClick: () => (e => !e.hasGroup && a(e))(e),
                        onMouseOver: () => (e => s(e))(e),
                        className: `mat-element ${t} ${ae[e.symbol]} ${
                            m ? 'hidden' : ''
                        } ${l ? 'enabled' : ''}\n          ${
            ...
            function me({onTableSwitcherClicked: e}) {
                const t = (function() {
                    const [e, t] = Object(i.useState)(''),
                        {observable: n} = Object(i.useContext)(te);
                    return n.subscribe
                        ? (Object(i.useEffect)(() => {
            ...
            function ue({
                ...
                const [l, c] = Object(i.useState)(!0),
                    m = Object(o.useMediaQuery)({minWidth: 992}),
                    u = Object(o.useMediaQuery)({minWidth: 768, maxWidth: 991}),
                    p = Object(o.useMediaQuery)({maxWidth: 767});
                return Object(i.createElement)(
                    'div',
                    {
                        className: `table-container ${pe(m, u, p, s)} ${
                            l ? '' : 'elements-hidden'
                        }`,
                    },
                    Object(i.createElement)(me, {
                        onTableSwitcherClicked: () => c(!l),
                    }),
                    ie.map(o =>
                        Object(i.createElement)(ce, {
                            onElementHovered: e => a(e),
            ...
            function pe(e, t, n, i) {
                return (
                    i ||
                    (e ? le.SPACED : t ? le.COMPACT : n ? le.MINI : le.SPACED)
                );
            }
            Object.seal(ae),
                (function(e) {
            ...
            const de = (e, t = !0) => e.reduce((e, n) => ((e[n] = t), e), {});
            function he(e) {
                const {
                    tableStateStore: t,
                    disabledEls: n,
            ...
            const ye = e => {
                    const t = de(e.enabledElements),
                        n = de(e.disabledElements),
                        r = de(e.hiddenElements),
                        {
                            enabledElements: o,
                            disabledElements: a,
                            hiddenElements: s,
            ...
            function we() {
                const [e, t] = Object(i.useState)({
                    ...
                    {actions: n} = Object(i.useContext)(te);
                return Object(i.createElement)(
                    'div',
                            ...
                            (e.exports = function(e, t) {
                                ...
                                var b =
                                    ...
                                    _ = {
                                        ...
                                        elementType: m(function(e, t, i, o, a) {
                                            var s = e[t];
...
*/ var r =
                        ...
                        e.exports = (function() {
                            ...
                            : function(e, t) {
                                  for (
                                      ...
                                      for (var m in (n = Object(arguments[c])))
                                          o.call(n, m) && (l[m] = n[m]);
                                      if (r) {
                                          s = r(n);
        ...
        (r.nextTick = function(e) {
            ...
            if (arguments.length > 1)
                for (var n = 1; n < arguments.length; n++)
                    t[n - 1] = arguments[n];
            c.push(new h(e, t)), 1 !== c.length || m || s(d);
        }),
    ...
    function(e, t, n) {
        ...
        var d = (function(e) {
            function t() {
                return (
                    ...
                    m(this, u(t).apply(this, arguments))
                );
            }
            var n, i, o;
            return (
        ...
        var _ = (function(e) {
            function t() {
                return (
                    ...
                    b(this, f(t).apply(this, arguments))
                );
            }
            var n, i, o;
            return (
        ...
        (j.propTypes = {id: a.a.string, children: a.a.any}),
            (j.defaultProps = {}),
            ...
            E = (function(e) {
                ...
                return (
                    ...
                    (t.prototype._subscribe = function(e) {
                        if (this.closed) throw new k();
                        return this.hasError
                            ? (e.error(this.thrownError), p.EMPTY)
                            : this.isStopped
                            ? (e.complete(), p.EMPTY)
