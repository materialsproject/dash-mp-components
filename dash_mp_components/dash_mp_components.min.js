window.dash_mp_components = (function(e) {
    ...
    function(e, t, n) {
        ...
        (function(e) {
            ...
            var P = (function() {
                ...
                z = (function() {
                    ...
                    return (
                        (e.prototype.call = function(e, t) {
                            return t.subscribe(
                                new R(e, this.compare, this.keySelector)
                            );
                        }),
                        e
                    );
            ...
            var L = (function() {
                ...
                G = (function(e) {
                    ...
                    return (
                        ...
                        (t.prototype._error = function(e) {
                            this.scheduleMessage(P.createError(e)),
                                this.unsubscribe();
                        }),
                        (t.prototype._complete = function() {
                            this.scheduleMessage(P.createComplete()),
                                this.unsubscribe();
                        }),
                        t
                    );
                ...
                $ = (function(e) {
                    ...
                    return (
                        ...
                        (t.prototype.nextTimeWindow = function(t) {
                            this._events.push(new J(this._getNow(), t)),
                        ...
                        return (
                            ...
                            l(n)
                                ...
                                : n &&
                                  ((o._context = n),
                                  (o._tapNext = n.next || w),
                                  (o._tapError = n.error || w),
                                  (o._tapComplete = n.complete || w)),
                            o
                        );
                    }
                    return (
            ...
            Object.seal(Z);
            const K = Object(i.createContext)({observable: {}, actions: {}});
            function X(e, t, n, r = 10, o) {
                const [a, s] = Object(i.useState)({}),
                    [l, c] = Object(i.useState)({}),
                    [u, m] = Object(i.useState)({}),
                    {observable: d, actions: p} = Object(i.useContext)(K);
                return (
                    Object(i.useEffect)(() => {
                        ...
                        const i = d.subscribe(
                            ...
                            a = d
                                .pipe(
                                    ...
                                    function(e) {
                                        return e.lift(new C(l, void 0));
                                    }),
                                    (function(e, t) {
                                        return (function(e, t) {
                                            return function(t) {
                                                return t.lift(new z(e, void 0));
                                            };
                                        })(function(n, i) {
                                            return t
                                                ? t(n[e], i[e])
            ...
            const ee = [
                ...
                te = ee.reduce((e, t) => ((e[t.symbol] = t), e), {});
            Object.seal(te);
            const ne = [
            ...
            Object.seal(ne);
            const ie = ne.reduce((e, t) => ((e[t.symbol] = t.class), e), {});
            var re, oe;
            function ae({
                element: e,
                displayMode: t = re.SIMPLE,
                hidden: n = !1,
                enabled: r = !1,
                disabled: o = !1,
                color: a,
                ...
                return Object(i.createElement)(
                    'div',
                    {
                        ...
                        className: `mat-element ${t} ${ie[e.symbol]} ${
                            m ? 'hidden' : ''
                        } ${c ? 'enabled' : ''}\n          ${
            ...
            Object.seal(ie),
                ((oe = re || (re = {})).SIMPLE = 'simple'),
                (oe.DETAILED = 'detailed');
            var le,
                ce,
                ue = (1 === (le = se).length &&
                    ((ce = le),
            ...
            var Oe = '\\s*([+-]?\\d+)\\s*',
                ...
                je = '\\s*([+-]?\\d*\\.?\\d+(?:[eE][+-]?\\d+)?)%\\s*',
                Ae = /^#([0-9a-f]{3,8})$/,
                Ie = new RegExp('^rgb\\(' + [Oe, Oe, Oe] + '\\)$'),
                Ce = new RegExp('^rgb\\(' + [je, je, je] + '\\)$'),
                Te = new RegExp('^rgba\\(' + [Oe, Oe, Oe, Ne] + '\\)$'),
                Me = new RegExp('^rgba\\(' + [je, je, je, Ne] + '\\)$'),
                Pe = new RegExp('^hsl\\(' + [Ne, je, je] + '\\)$'),
                ze = new RegExp('^hsla\\(' + [Ne, je, je, Ne] + '\\)$'),
                Re = {
                    aliceblue: 15792383,
            ...
            function He(e) {
                ...
                return (
                    ...
                    (t = Ae.exec(e))
                        ...
                        : (t = Pe.exec(e))
                        ? Je(t[1], t[2] / 100, t[3] / 100, 1)
                        : (t = ze.exec(e))
                        ? Je(t[1], t[2] / 100, t[3] / 100, t[4])
                        : Re.hasOwnProperty(e)
                        ? De(Re[e])
                        : 'transparent' === e
            ...
            function De(e) {
                return new Ue((e >> 16) & 255, (e >> 8) & 255, 255 & e, 1);
            }
            function Fe(e, t, n, i) {
                return i <= 0 && (e = t = n = NaN), new Ue(e, t, n, i);
            }
            function Ge(e, t, n, i) {
                return 1 === arguments.length
                    ? (function(e) {
                          return (
                              e instanceof Se || (e = He(e)),
                              e
                                  ? new Ue((e = e.rgb()).r, e.g, e.b, e.opacity)
                                  : new Ue()
                          );
                      })(e)
                    : new Ue(e, t, n, null == i ? 1 : i);
            }
            function Ue(e, t, n, i) {
                (this.r = +e),
                    (this.g = +t),
            ...
            function Ve(e) {
                ...
                if ((e instanceof Se || (e = He(e)), !e)) return new Ye();
                    ...
                    Ee(Se, {
                        ...
                        rgb: function() {
                            var e = (this.h % 360) + 360 * (this.h < 0),
                                ...
                                r = 2 * n - i;
                            return new Ue(
                                Qe(e >= 240 ? e - 240 : e + 120, r, i),
                                Qe(e, r, i),
                                Qe(e < 120 ? e + 240 : e - 120, r, i),
                                this.opacity
                            );
                        },
                        displayable: function() {
            ...
            var Xe = (function e(t) {
                ...
                function i(e, t) {
                    var i = n((e = Ge(e)).r, (t = Ge(t)).r),
                        r = n(e.g, t.g),
                        o = n(e.b, t.b),
                        a = Ke(e.opacity, t.opacity);
                    return function(t) {
                        return (
                            (e.r = i(t)),
                            (e.g = r(t)),
            ...
            var ot = /[-+]?(?:\d+\.?\d*|\.?\d+)(?:[eE][-+]?\d+)?/g,
                at = new RegExp(ot.source, 'g');
            function st(e, t) {
                var n,
                    i,
                    r,
                    o = (ot.lastIndex = at.lastIndex = 0),
                    a = -1,
                    s = [],
                    l = [];
                for (e += '', t += ''; (n = ot.exec(e)) && (i = at.exec(t)); )
                    (r = i.index) > o &&
                        ((r = t.slice(o, r)),
                        s[a] ? (s[a] += r) : (s[++a] = r)),
                        (n = n[0]) === (i = i[0])
            ...
            function ft(e, t, n) {
                ...
                for (
                    ...
                    (r[a] = pt(e[a], e[a + 1])), (o[a] = n(t[a], t[a + 1]));
                return function(t) {
                    var n = ue(e, t, 1, i) - 1;
                    return o[n](r[n](t));
                };
            ...
            function gt(e) {
                return (e = bt(Math.abs(e))) ? e[1] : NaN;
            }
            var _t,
                vt = /^(?:(.)?([<>=^]))?([+\-( ])?([$#])?(0)?(\d+)?(,)?(\.\d+)?(~)?([a-z%])?$/i;
            function wt(e) {
                ...
                return (
                    ...
                    (e.tickFormat = function(e, n) {
                        ...
                        return (function(e, t, n, i) {
                            ...
                            return Nt(i);
                        })(i[0], i[i.length - 1], null == e ? 10 : e, n);
                    }),
                    (e.nice = function(n) {
                        null == n && (n = 10);
                        var i,
                ...
                var e = (function(e, t) {
                    return (function() {
                        ...
                        function u() {
                            return (
                                (i =
                                    Math.min(a.length, s.length) > 2 ? ft : yt),
                                (r = o = null),
                                m
                            );
                        }
                        ...
                        return (
                            (m.invert = function(n) {
                                return c(t((o || (o = i(s, a.map(e), it)))(n)));
                            }),
                            (m.domain = function(e) {
            ...
            function Pt({onTableSwitcherClicked: e}) {
                const t = (function() {
                    const [e, t] = Object(i.useState)(''),
                        {observable: n} = Object(i.useContext)(K);
                    return n.subscribe
                        ? (Object(i.useEffect)(() => {
                ...
                return Object(i.createElement)(
                    ...
                    Object(i.createElement)(
                        ...
                        t &&
                            Object(i.createElement)(ae, {
                                displayMode: re.DETAILED,
                                disabled: !1,
                                enabled: !1,
                                hidden: !1,
                                color: void 0,
            ...
            function zt({
                ...
                return Object(i.createElement)(
                    ...
                    Object(i.createElement)(
                        'div',
                        {
                            className: `table-container ${Rt(y, f, b, s)} ${
                                m ? '' : 'elements-hidden'
                            }`,
                        },
                        Object(i.createElement)(Pt, {
            ...
            function Rt(e, t, n, i) {
                return (
                    i ||
                    (e ? At.SPACED : t ? At.COMPACT : n ? At.MINI : At.SPACED)
                );
            }
            function Lt(e) {
            ...
            (Ot = (function(e) {
                ...
                return {
                    ...
                    formatPrefix: function(e, t) {
                        var n = m((((e = wt(e)).type = 'f'), e)),
                            i =
                                3 *
                                Math.max(
                                    -8,
                                    Math.min(8, Math.floor(gt(t) / 3))
                                ),
                            r = Math.pow(10, -i),
                            o = Ct[8 + i / 3];
                        return function(e) {
            ...
            const Bt = (e, t = !0) => e.reduce((e, n) => ((e[n] = t), e), {});
            function Ht(e) {
                const {
                    tableStateStore: t,
                    disabledEls: n,
            ...
            const Dt = e => {
                    const t = Bt(e.enabledElements),
                        n = Bt(e.disabledElements),
                        r = Bt(e.hiddenElements),
                        {
                            enabledElements: o,
                            disabledElements: a,
                            hiddenElements: s,
                            actions: l,
                        } = X(n, t, r, e.maxElementSelectable, e.onStateChange);
                    return (
                        Object(i.useEffect)(() => {
            ...
            function Wt() {
                const [e, t] = Object(i.useState)({
                    ...
                    {actions: n} = Object(i.useContext)(K);
                return Object(i.createElement)(
                    'div',
            ...
            function qt(e) {
                ...
                return Object(i.createElement)(
                    'div',
                    {
                        className: 'mp-element-wrapper',
                        style: {width: t, height: t},
                    },
                    Object(i.createElement)(ae, Object.assign({}, n))
                );
            }
            function $t(t) {
                const n = Object(i.useMemo)(
                    () =>
                        (function() {
                            let t = Z;
                            const n = new r.a();
        ...
        var C = (function(e) {
            function t() {
                return (
                    ...
                    j(this, A(t).apply(this, arguments))
                );
            }
            var n, i, o;
            return (
