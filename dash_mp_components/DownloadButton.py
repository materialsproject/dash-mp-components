...
Keyword arguments:
- children (a list of or a singular dash component, string or number; optional): Use the children prop to set the button content
...
- data (optional): Array or object (list or dictionary) to be downloaded
If downloading as csv or xlsx, data must be an array/list
- filename (string; optional): Name of the file WITHOUT the extension
(default: "export")
- filetype (a value equal to: 'json', 'csv', 'xlsx'; optional): File type to be downloaded
