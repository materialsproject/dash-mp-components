...
Keyword arguments:
- children (a list of or a singular dash component, string or number; optional): Use the children prop to set the content of the formula.
Must be a simple string.
- id (string; optional): The ID used to identify this component in Dash callbacks
- setProps (optional): Dash-assigned callback that should be called whenever any of the
properties change
- className (string; optional): Class name(s) to append to the component's default class (mpc-formula)"""
    @_explicitize_args
    def __init__(self, children=None, id=Component.UNDEFINED, className=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'setProps', 'className']
        self._type = 'Formula'
        self._namespace = 'dash_mp_components'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'setProps', 'className']
